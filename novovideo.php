             ...
             <div class="row">
                     <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                             <div class="list-group">
                                          ...
                                          <a href="#" class="list-group-item">Cadastrar Novo Vídeo</a>
                         ...
                         <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                             <div class="container2">
                                     <div class="panel panel-default">
                                                 <div class="panel-heading"><h5>Painel do Instrutor</h5></div>
                                                 <div class="panel-body">										     
                                                 
                                                     <table>
                                                         <tr>
                                                                <td>
                                                                    <a href="https://vimeo.com/log_in" target="_blank"><img src="imagens/vimeo.png" width="100" height="30"></a>
                                                                </td>	
                                                                <td>
                                                                    <a href="https://www.youtube.com/?gl=BR" target="_blank"><img src="imagens/youtube.png" width="200" height="90"></a>
                                                                </td>														                                                                                                                        
                                                       </tr>
                                                       <tr>
                                                                <td>
                                                                    <button type="button" class="btn btn-link"><a href="https://vimeo.com/log_in" target="_blank">Ir para o Vimeo</a></button>
                                                                </td>	
                                                                <td>
                                                                    <button type="button" class="btn btn-link"><a href="https://www.youtube.com/?gl=BR" target="_blank">Ir para o You tube</a></button>
                                                                </td>														                                                                                                                        
                                                       </tr>
                                                     </table>   
