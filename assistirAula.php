             ...
             <div class="row">
                     <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                         ...
                         <?php
                           ...
                           $sql_consultar = mysqli_query($link, 
                                   "SELECT id_aulas_cda, st_titulo_cda, st_descricao_cda,"
                                   . "nu_numAula_cda, st_link_cda, st_curso_cda "
                                   . "FROM cadAulas_cda WHERE st_curso_cda = '$id_cursos_cdc' ");
                                   while($row = mysqli_fetch_array($sql_consultar)){
                                                   $id_aulas_cda = $row['id_aulas_cda'];
                                                   $st_titulo_cda = $row['st_titulo_cda'];
                                                   $st_descricao_cda = $row['st_descricao_cda'];
                                                   $nu_numAula_cda = $row['nu_numAula_cda'];
                                                   $st_link_cda = $row['st_link_cda'];
                                                   $st_curso_cda = $row['st_curso_cda'];
                             ...
                             <tr>
                                 <td>
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="number" name="nu_numAula_cda" id="campoNum" value="<?php echo $nu_numAula_cda ?>" disabled>
                                    </div> 
                                 </td>
                                 <td>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-tag"></i></span>					 
                                        <input class="form-control" type="text" name="st_titulo_cda" id="campoTitulo" value="<?php echo $st_titulo_cda ?>" disabled>
                                    </div> 
                                 </td>
                                 <td>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-tag"></i></span>					 
                                        <input class="form-control" type="text" name="st_descricao_cda" id="campoDescricao" value="<?php echo $st_descricao_cda ?>" disabled>
                                    </div> 
                                 </td>
                                 <td>
                                     <a href="aula.php?st_link_cda=<?php echo $st_link_cda ?>" target="_blank">Assistir</a> 
                                 </td>
                             </tr>
                             <?php
                                }
