			 ...
			 <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
				 ...
				 <div class="panel panel-default">
				     <div class="panel-heading"><h5>Perfil do Aluno</h5></div>
						 ...
						 <form class="formulario" method="post" action="delInst.php">
						 <!-- Linha 1.0 -->						
						 ...
						 <!-- Linha 1.0 -->
                                                 <?php 
                                                    ...
                                                    $sql_consultar = mysqli_query($link, 
                                                            "SELECT id_instrutor_cdi, st_nome_cdi "                                                            
						 ...
						 <!-- Linha 1.3 -->			
						 <tr>
                                                     <th><h5>Você deseja realmente encerrar sua conta?</h5></th><th></th>
						 ...
						 <!-- Linha 1.3 -->
                                                 ...
                                                 <!-- Linha 1.4 -->			
						 <tr>
                                                     <th><h5>Se sim clique em encerrar conta!</h5></th><th></th>
