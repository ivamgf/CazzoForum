                                ...
                                <div class="panel panel-default">
                                    ...
                                    <?php
                                     ...
                                     $sql_consultar = mysqli_query($link, "SELECT id_compras_cdc, st_usuario_cdc, st_titulo_cdc,"
                                             ...
                                             . "FROM cadCompras_cdc WHERE fl_liberado_cdc = 'S' ORDER BY id_compras_cdc ");
                                     ...
                                     //Código de consulta                                                                                                                                
                                             ...
                                             ?>
                                                    ...
                                                    <tr>
                                                    <th>Código da Compra</th><th>Curso</th><th></th>
                                                    </tr>
                                                    <!-- Linha 1.1 -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        </td><td><a href="dashboard3.php?id_compras_cdc=<?php echo $id_compras_cdc ?>">Ir para o Curso</a></td>
                                                    </tr>
                                                    <!-- Linha 1.2 -->
                                                    <?php
                                                 }
